...
The developers of the game can use this data to ensure the sides of the match are balanced. Are teams that start on the attack side have an advantage? Maybe teams that start on defend given an unfair advantage during pistol rounds. This might lead them into rebalancing the damage numbers of the pistols, or maybe changing, adding, or taking away assests around the map to make it easier or tougher for one of the sides.
