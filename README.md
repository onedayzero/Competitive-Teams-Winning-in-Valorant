...
The developers of the game can use this data to ensure the sides of the match are balanced. Are teams that start on the attack side have an advantage? Maybe teams that start on defend have an advantage in the pistol rounds, so maybe a team might look into what they can do to equalize by removing cover.
